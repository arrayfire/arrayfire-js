...
class AFArray extends Disposable {
    ...
    constructor(af, handle) {
        ...
        this._assignOther = this._makeAssignOther();
    }
    ...
    get() {
        // TODO: async
        const newHandle = af.index(this, ...arguments);
    ...
    set(...args) {
        return rhs => {
            // TODO: async
            const newHandle = af.assign(this, rhs, ...args);
            this.dispose();
            this.resetDisposeFunction(() => af.releaseArray(newHandle));
