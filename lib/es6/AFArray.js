    ...
    static define(af) {
        ...
        af.array = af._makeFunction(
            function () {
                ...
                let thirdArg = arguments[nextIndex.value];

                if (_.isArray(thirdArg)) {
                    thirdArg = helpers.arrayToBuffer(thirdArg);
                }
                ...
                if (Buffer.isBuffer(thirdArg)) {
                    ...
                    if (source === af.source.host) {
                        return af.createArray(thirdArg, dims, type);
                    }
                    return af.deviceArray(thirdArg, dims, type);
                }
