...
module.exports = function (af) {
    ...
    af.deviceInfo = af._makeFunction(function () {
    ...
    if (lib.isSymbolExists('af_info_string')) {
        ...
        af.infoString = af._makeFunction(function () {
    ...
    af.getDeviceCount = af._makeFunction(function () {
    ...
    af.setDevice = af._makeFunction(function (id) {
    ...
    af.getDevice = af._makeFunction(function () {
        this.res = ref.alloc(ref.types.int);
    }, function () {
    ...
    af.setSeed = af._makeFunction(function (seed) {
    ...
    af.sync = af._makeFunction(function () {
        var deviceId = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : -1;
